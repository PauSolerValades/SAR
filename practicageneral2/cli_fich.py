...
LINEA = ('-' * 39)												# Definicion para printear las lineas
SERVER = 'localhost'											# Direccion IP del socket
PORT = 50014													# Puerto del socket
ER_MSG = {														# Diccionario de los distintos codigos de error que puede devolver el servidor
...
while True:
	...
	if logged == False:												# En caso de que no nos hayamos logeado el cliente nos pedira usuario y contrasena
		msg = log()													# y hasta que no lo introduzcamos perfectamente no podremos acceder al resto de funciones
